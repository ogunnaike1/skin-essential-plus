...
export function HeroCarousel(): React.ReactElement {
  ...
  // Get link props for primary and secondary CTAs
  const primaryLinkProps = activeSlide ? getLinkProps(activeSlide.ctaPrimary) : null;
  const secondaryLinkProps = activeSlide ? getLinkProps(activeSlide.ctaSecondary) : null;
