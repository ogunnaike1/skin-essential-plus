        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            <div className="absolute inset-0 opacity-30">
              <Image
                src="https://res.cloudinary.com/dhmqhless/image/upload/q_auto:good,f_auto/v1778795958/sanctuary_abo2g1.jpg"
                alt=""
                fill
                sizes="100vw"
            ...
            <div className="relative px-8 sm:px-16 py-20 sm:py-28 text-center">
              ...
              >
                ...
                {/* View Pricing Button - Links to Services */}
                <Link
                  href="/services"
                  className="group inline-flex items-center justify-center gap-2 px-9 py-4 bg-transparent text-ivory border border-ivory/30 font-sans text-sm uppercase tracking-[0.2em] rounded-full hover:bg-ivory/10 hover:border-ivory/60 transition-all duration-500"
                >
                  View Pricing
