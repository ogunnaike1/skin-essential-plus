...
import { formatShopPrice, getBestSellers } from "@/lib/shop-data";
import { cn } from "@/lib/utils";

/**
 * Best sellers row — 4 top-rated products on a palette-gradient section.
 * Every card is fully solid, zero backdrop-blur, zero hover-scale on buttons.
 */
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-square overflow-hidden bg-deep/5">
                  ...
                  {/* Quick-shop button — bottom-right, solid */}
                  <button
                    type="button"
